...
<div class="col-lg-12 order-lg-1 ">
  <div class="card shadow mb-4">
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Data Pemasukan Donasi</h6>
      </div>

      <div class="card-body">

          <form method="POST" action="{{ route('admin.pembayaranluring.store') }}" enctype="multipart/form-data">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <h6 class="heading-small text-muted mb-4">Tambah Data Pemasukan Donasi</h6>
